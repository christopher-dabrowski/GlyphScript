...
public class FloatOperations : IOperationProvider
{
    ...
    public GlyphScriptValue Power(GlyphScriptValue left, GlyphScriptValue right)
    {
        ...
        {
            var powType = LLVM.FunctionType(LLVM.DoubleType(), new[] { LLVM.DoubleType(), LLVM.DoubleType() }, false);
            powFunc = LLVM.AddFunction(_llvmModule, "pow", powType);
        }

        var powResult = LLVM.BuildCall(_llvmBuilder, powFunc, new[] { leftDouble, rightDouble }, "pow_call");
    ...
    public GlyphScriptValue? PrintImplementation(RuleContext context, IReadOnlyList<GlyphScriptValue> parameters)
    {
        ...
        LLVM.BuildCall(_llvmBuilder, printfFunc, new[] { formatPtr, doubleValue }, string.Empty);
    ...
    public GlyphScriptValue? ReadImplementation(RuleContext context, IReadOnlyList<GlyphScriptValue> parameters)
    {
        ...
        LLVM.BuildCall(_llvmBuilder, scanfFunc, new[] { formatPtr, tempVar }, string.Empty);
    ...
    public IReadOnlyDictionary<OperationSignature, OperationImplementation> Operations =>
        ...
        {
            { new OperationSignature(DefaultValue, new[] { GlyphScriptType.Float }), DefaultValueImplementation },
            { new OperationSignature(ParseImmediate, new[] { GlyphScriptType.Float }), ParseImmediateImplementation },

            // Float-Float operations
            { new OperationSignature(Addition, new[] { GlyphScriptType.Float, GlyphScriptType.Float }), AdditionImplementation },
            { new OperationSignature(Subtraction, new[] { GlyphScriptType.Float, GlyphScriptType.Float }), SubtractionImplementation },
            { new OperationSignature(Multiplication, new[] { GlyphScriptType.Float, GlyphScriptType.Float }), MultiplicationImplementation },
            { new OperationSignature(Division, new[] { GlyphScriptType.Float, GlyphScriptType.Float }), DivisionImplementation },
            { new OperationSignature(OperationKind.Power, new[] { GlyphScriptType.Float, GlyphScriptType.Float }), PowerImplementation },

            // Float-Int operations
            { new OperationSignature(Addition, new[] { GlyphScriptType.Float, GlyphScriptType.Int }), AdditionImplementation },
            { new OperationSignature(Addition, new[] { GlyphScriptType.Int, GlyphScriptType.Float }), AdditionImplementation },
            { new OperationSignature(Subtraction, new[] { GlyphScriptType.Float, GlyphScriptType.Int }), SubtractionImplementation },
            { new OperationSignature(Subtraction, new[] { GlyphScriptType.Int, GlyphScriptType.Float }), SubtractionImplementation },
            { new OperationSignature(Multiplication, new[] { GlyphScriptType.Float, GlyphScriptType.Int }), MultiplicationImplementation },
            { new OperationSignature(Multiplication, new[] { GlyphScriptType.Int, GlyphScriptType.Float }), MultiplicationImplementation },
            { new OperationSignature(Division, new[] { GlyphScriptType.Float, GlyphScriptType.Int }), DivisionImplementation },
            { new OperationSignature(Division, new[] { GlyphScriptType.Int, GlyphScriptType.Float }), DivisionImplementation },
            { new OperationSignature(OperationKind.Power, new[] { GlyphScriptType.Float, GlyphScriptType.Int }), PowerImplementation },
            { new OperationSignature(OperationKind.Power, new[] { GlyphScriptType.Int, GlyphScriptType.Float }), PowerImplementation },

            // Float-Long operations
            { new OperationSignature(Addition, new[] { GlyphScriptType.Float, GlyphScriptType.Long }), AdditionImplementation },
            { new OperationSignature(Addition, new[] { GlyphScriptType.Long, GlyphScriptType.Float }), AdditionImplementation },
            { new OperationSignature(Subtraction, new[] { GlyphScriptType.Float, GlyphScriptType.Long }), SubtractionImplementation },
            { new OperationSignature(Subtraction, new[] { GlyphScriptType.Long, GlyphScriptType.Float }), SubtractionImplementation },
            { new OperationSignature(Multiplication, new[] { GlyphScriptType.Float, GlyphScriptType.Long }), MultiplicationImplementation },
            { new OperationSignature(Multiplication, new[] { GlyphScriptType.Long, GlyphScriptType.Float }), MultiplicationImplementation },
            { new OperationSignature(Division, new[] { GlyphScriptType.Float, GlyphScriptType.Long }), DivisionImplementation },
            { new OperationSignature(Division, new[] { GlyphScriptType.Long, GlyphScriptType.Float }), DivisionImplementation },
            { new OperationSignature(OperationKind.Power, new[] { GlyphScriptType.Float, GlyphScriptType.Long }), PowerImplementation },
            { new OperationSignature(OperationKind.Power, new[] { GlyphScriptType.Long, GlyphScriptType.Float }), PowerImplementation },

            // IO operations
            { new OperationSignature(Print, new[] { GlyphScriptType.Float }), PrintImplementation },
            { new OperationSignature(Read, new[] { GlyphScriptType.Float }), ReadImplementation }
        };
}
